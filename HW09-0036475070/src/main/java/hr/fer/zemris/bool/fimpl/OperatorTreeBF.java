...
public class OperatorTreeBF implements BooleanFunction {
	...
	/**
	 * Vraca listu indexa minterma funkcije.
	 * 
	 * @return lista integera
	 */
	public List<Integer> getMintermIndex() {
		return mintermIndex;
	}

	/**
	 * Vraca listu indexa maksterma funkcije.
	 * 
	 * @return lista integera
	 */
	public List<Integer> getMaxtermIndex() {
		return maxtermIndex;
	}

	/**
	 * Vraca listu indexa dont careova funkcije.
	 * 
	 * @return lista integera
	 */
	public List<Integer> getDontCareIndex() {
	...
	private void createIndexLists() {
		...
		for (int i = 0, length = (int) Math.pow(2, domainSize); i < length; i++) {
			...
			// vrijednosti koje
			// su u maski
			Mask maska = Mask.fromIndex(false, domainSize, i);
	...
	/**
	 * Postavlja vrijednost varijabla domene na one redom primljene iz maske.
	 * 
	 * @param maska
	 */
	public void setValue(Mask maska) {
