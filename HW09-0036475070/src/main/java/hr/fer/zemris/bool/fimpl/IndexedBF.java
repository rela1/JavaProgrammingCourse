...
public class IndexedBF implements BooleanFunction {
	...
	/**
	 * True ako su indexi mintermi, false ako su indexi makstermi.
	 * 
	 * @return true ako su indexi mintermi, false ako su makstermi
	 */
	public boolean isIndexesAreMinterms() {
		return indexesAreMinterms;
	}

	/**
	 * Vraca listu indeksa funkcije.
	 * 
	...
	/**
	 * Vraca listu dont care indeksa funkcije.
	 * 
	 * @return lista integera
	 */
	...
	/**
	 * Vraca drugi dio indeksa funkcije.
	 * 
	 * @return lista integera
	 */
	...
	public BooleanValue getValue() {
		...
		for (int i = 0, length = domainIndexes.size(), maskSize = domain.size(); i < length; i++) {
			Mask pom = Mask.fromIndex(false, maskSize, i);
