...
/**
 * Kolekcija koja kao kljuc sadrzava string, a svakom kljucu se moze pridruziti vise objekata kroz
 * pratecu strukturu u obliku stoga.
 * 
 * @author Ivan Relic
 *
 */
public class ObjectMultistack {
	...
	/**
	 * Static klasa predstavlja strukturu podataka stog u obliku jednostruko povezane liste.
	 * 
	 * @author Ivan Relic
	 *
	 */
	 ...
	 * 
	 * @param name kljuc stoga
	 * @param valueWrapper vrijednost koju dodajemo na stog
	 */
	public void push(String name, ValueWrapper valueWrapper) {
		
		//ako navedeno ime stoga ne postoji u mapi dodaj ga i kreiraj stog za njega
