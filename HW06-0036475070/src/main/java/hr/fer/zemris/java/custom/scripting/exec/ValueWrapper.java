...
/**
 * Klasa je wrapper za vrijednosti koje se mogu nalaziti na stacku kod klase ObjectMultiStack.
 * 
 * @author Ivan Relic
 *
 */
public class ValueWrapper {
	 ...
	 * 
	 * @param value vrijednost koja se postavlja u clansku varijablu
	 */
	 ...
	 * 
	 * @param incValue vrijednost za koju povecavamo
	 */
	 ...
	 * 
	 * @param decValue vrijednost za koju smanjujemo
	 */
	 ...
	 * 
	 * @param mulValue vrijednost s kojom mnozimo
	 */
	 ...
	 * 
	 * @param divValue vrijednost s kojom se dijeli
	 */
	 ...
	 * 
	 * @param withValue vrijednost za usporedbu
	 * @return 1 ako je clanska varijabla veca, -1 ako je manja, 0 ako su jednake
	 */
	...
	/**
	 * Metoda prima dva objekta i znak operacije medju njima i vraca rezultat te operacije.
	 * 
	 * @param originalValue vrijednost prvog operatora
	 * @param operationValue vrijednost drugog operatora
	 * @param operator operatori: + zbrajanje, - oduzimanje, * mnozenje, / dijeljenje, 
	 * = usporedjivanje
	 * @return
	 */
	private Object operation(Object originalValue, Object operationValue, char operator) {
		...
		if (operator == '+') {
			...
			//ako je originalValue double, castaj ih tako
			if (originalValue instanceof Double) {
				return ((Double) originalValue).compareTo((Double) operationValue);
			}
			
			//inace, sigurno je integer
			return ((Integer) originalValue).compareTo((Integer) operationValue);
		}
				
	}

	/**
	 * Metoda vraca integer prikaz primljenog objekta. Obavezno je prije toga pozvati metodu is
	 * integer.
	 * 
	 * @param value objekt koji zelimo kao integer
	...
	/**
	 * Metoda vraca double prikaz primljenog objekta. Obavezno je prije toga pozvati metodu is
	 * Double.
	 * 
	 * @param value objekt koji zelimo kao double
	...
	/**
	 * Metoda provjerava je li primljeni argument null, ako je vraca novi integer vrijednosti 0.
	 * 
	 * @param Value argument koji provjeravamo
	 ...
	 * 
	 * @param value argument za koji provjeravamo je li integer
	 * @return true ako je, false inace
	 */
	private boolean isInteger(Object value) {
		
		//prvo probaj castati u string, pa parseInt metodom u Integer, ako sve prodje u redu, true
		try {
		...
		//probaj castati direktno u Integer, ako prodje, vrati true, inace false
		try {
	 ...
	 * 
	 * @param value argument za koji provjeravamo je li double
	 * @return true ako je, false inace
	 */
	private boolean isDouble(Object value) {
		
		//ako string odgovara obliku [+-][BROJ].[BROJ] ili [+-][BROJ]E[+-][BROJ] vrati true
		try {
	 ...
	 * 
	 * @param value vrijednost koju zelimo postaviti
	 */
