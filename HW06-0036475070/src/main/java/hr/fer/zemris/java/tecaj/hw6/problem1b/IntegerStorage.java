...
/**
 * Klasa "subjekta" koji provodi promjenom nad svojim sadrzajem i obavjestava "observere" da je
 * doslo do promjene.
 * 
 * @author Ivan Relic
 *
...
public class IntegerStorage {
	...
	public void setValue(int value) {
		...
		IntegerStorageChange change = null;
		
		if (value != this.value) {
			change = new IntegerStorageChange(this, value);
			this.value = value;
		}
		...
		if (observers != null) {
			...
			//iteracija kopijom liste zbog moguceg brisanja observera za double value i unistavanja
			//slijednosti liste
			if (change != null) {
